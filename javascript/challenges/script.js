...
//challenge Three: Rock, Paper, Scissprs
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage){
	...
	messageDiv.innerHTML = "<h1 style='color: " + finalMessage['color'] + "; font-sez: 60px; padding: 30px; '>" + finalMessage['message'] + "</h1>"
